...
def load_from_tf(name):
    return tf.train.load_variable("./data/model", name=name)
...
# exp 1
save_path = "./tmp/basal"
pos_data_path = "./data/data_model_1_basal/C57Bl6_basalEnhancers.positive.fa"
neg_data_path = "./data/data_model_1_basal/C57Bl6_basalEnhancers.negative.fa"
run(pos_data_path, neg_data_path, save_path)

# exp 2
save_path = "./tmp/IL4"
pos_data_path = "./data/data_model_2_IL4/C57Bl6_IL4Enhancers.positive.fa"
neg_data_path = "./data/data_model_2_IL4/C57Bl6_IL4Enhancers.negative.fa"
run(pos_data_path, neg_data_path, save_path)

# exp 3
save_path = "./tmp/IL4Induced"
pos_data_path = "./data/data_model_3_induced/Strains_IL4InducedEnhancers.positive.fa"
neg_data_path = "./data/data_model_3_induced/Strains_IL4InducedEnhancers.negative.fa"
run(pos_data_path, neg_data_path, save_path)
